...
const Index = () => {
  return (
    <div className="min-h-screen bg-app-background">
      ...
      <Helmet>
        <title>Image Format Converter | Resize for Social Media, Crop & Convert Images | Free Online Tool</title>
        ...
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Image Format Converter | Resize for Social Media, Crop & Convert Images" />
        ...
        <meta name="twitter:title" content="Image Format Converter | Resize for Social Media, Crop & Convert Images" />
      ...
      <section className="pt-12 pb-8 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-app-text mb-3">
            Image Format Converter: Resize for Social Media & Convert Formats
          </h1>

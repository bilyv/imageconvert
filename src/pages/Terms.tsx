      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>If you have questions about these terms, please contact us at <a href="mailto:ntwaribrian92@gmail.com" className="text-app-primary hover:underline">ntwaribrian92@gmail.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
